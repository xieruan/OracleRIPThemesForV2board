...
<head>
    <meta charset="UTF-8" />
    <title>{{$title}}</title>
    <script type="module" crossorigin src="/theme/{{$theme}}/assets/index.b5eab8ba.js?v={{$version}}"></script>
    <link rel="modulepreload" href="/theme/{{$theme}}/assets/vendor.cc981c55.js?v={{$version}}">
    <link rel="stylesheet" href="/theme/{{$theme}}/assets/index.17af1527.css?v={{$version}}">
